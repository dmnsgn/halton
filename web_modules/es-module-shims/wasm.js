...
/* ES Module Shims Wasm 2.0.9 */ (function() {
    ...
    const tsTransform = esmsInitOptions.tsTransform || document.currentScript && document.currentScript.src.replace(/\.js$/, '-typescript.js') || './es-module-shims-typescript.js';
